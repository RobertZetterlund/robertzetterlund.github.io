...
export const Tech = () => {
  return (
    <Main>
      <div>I have also spent some time doing react-native.</div>
      <Dify />
      <JMT />
      <Otorix />
    </Main>
...
const JMT = () => (
  <Grid.Box>
    <Grid.Text>
      With my classmate Markus Pettersson, I created and sold JMT Rapport to a
      client.
      <ul>
        <li>Complete ownership over product and time spent</li>
        <li>
          Rendering of components and forms with reducer pattern with data
          hosted on firebase
        </li>
      </ul>
    </Grid.Text>
...
const Education = () => <Grid.Box>I can write whatever I want here.</Grid.Box>;
